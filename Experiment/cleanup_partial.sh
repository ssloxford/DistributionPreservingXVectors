...
#
# This partial cleanup script cleans up most of the stages of the VoicePrivacy challenge from 8 onwards.
# In order to save time it does not delete any xvector extraction results, as these are very slow, particularly with VoxCeleb
# 
